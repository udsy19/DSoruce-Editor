...
// The KPI derivation lives in `kpis.ts` — ONE source, shared with the on-screen
// metrics card. Re-exported here so every existing importer of `report.ts` is
// untouched by the move.
export type { AlternativeInput, SpaceMix, AltKpis, ReportMeta, ReportModel } from './kpis'
export { computeAltKpis, DAYLIGHT_RADIUS_M, LEGEND_ORDER, ZONE_LABEL } from './kpis'
import type { AlternativeInput, AltKpis, ReportMeta, ReportModel, SpaceMix } from './kpis'
import { computeAltKpis, LEGEND_ORDER, ZONE_LABEL } from './kpis'
