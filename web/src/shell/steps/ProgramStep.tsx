...
import type { Placement } from '../../editor/EditorCanvas'
        ...
        <aside className="program-summary" data-testid="program-summary">
          ...
          <div className="program-summary-metrics">
            <div className="program-summary-metric">
              <span className="program-summary-value num">{totals?.enclosedRooms ?? 0}</span>
              <span className="program-summary-label">enclosed rooms</span>
            </div>
            <div className="program-summary-metric">
