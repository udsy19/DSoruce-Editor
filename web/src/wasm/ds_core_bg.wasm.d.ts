...
export const editor_add_keepout: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
export const editor_add_wall: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
...
export const editor_assign_product: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
...
export const editor_ground_truth_json: (a: number, b: number, c: number) => [number, number];
...
export const editor_move_component: (a: number, b: number, c: number, d: number) => void;
...
export const editor_set_component_rotation: (a: number, b: number, c: number) => void;
export const editor_set_component_size: (a: number, b: number, c: number, d: number) => void;
export const editor_set_decision: (a: number, b: number, c: number, d: number) => void;
export const editor_set_wall: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const editor_set_wall_height: (a: number, b: number, c: number) => void;
