...
export class Editor {
     ...
     */
    density_score(): number | undefined;
    /**
...
export interface InitOutput {
    ...
    readonly editor_add_anchor: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly editor_add_component: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly editor_add_entry: (a: number, b: number, c: number) => [number, number];
    readonly editor_add_keepout: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly editor_add_wall: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    ...
    readonly editor_assign_product: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
    ...
    readonly editor_density_score: (a: number) => [number, number];
    ...
    readonly editor_move_component: (a: number, b: number, c: number, d: number) => [number, number];
    readonly editor_move_selected: (a: number, b: number, c: number) => [number, number];
    ...
    readonly editor_select_at: (a: number, b: number, c: number) => [number, number, number];
    ...
    readonly editor_set_component_rotation: (a: number, b: number, c: number) => [number, number];
    readonly editor_set_component_size: (a: number, b: number, c: number, d: number) => [number, number];
    readonly editor_set_decision: (a: number, b: number, c: number, d: number) => void;
    readonly editor_set_wall: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    readonly editor_set_wall_height: (a: number, b: number, c: number) => [number, number];
